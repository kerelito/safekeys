...
document.getElementById("refreshRfidUsersButton").addEventListener("click", loadRfidUsers);
document.getElementById("refreshRfidItemsButton").addEventListener("click", loadRfidItems);
document.getElementById("refreshPanelUsersButton").addEventListener("click", loadPanelUsers);
